...
public class FileUtils {
    ...
    public static  <T> List<T> readDataFromFile(String fileName, int classID){
        ...
        try {
            FileReader fileReader = new FileReader("F:\\BaoThi\\C0123K1_Module2\\src\\main\\java\\casedemo\\data\\book.csv");
    ...
    public static <T> void writeDataToFile(String fileName, List<T> datas){
        try {
