...
public class ManagerCustomer {
    ...
    public ManagerCustomer() {
        ...
        customers.add(new Customer(1, "Doraemon", "doraemon@gmail.com", "Huế", new Date()));
        customers.add(new Customer(2, "Nobita", "nobita@gmail.com", "Hà Nội", new Date()));
        customers.add(new Customer(3, "Shizuka", "shizuka@gmail.com", "Hồ Chí Minh", new Date()));
        customers.add(new Customer(4, "Suneo", "suneo@gmail.com", "Quảng Trị", new Date()));
        customers.add(new Customer(5, "Jaian", "jaian@gmail.com", "Đà Lạt", new Date()));
    }
        ...
        do {
            ...
            switch (actionMenu) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    managerCustomer.sortByCreateDate();
                    break;
                case 7:
    ...
    public void sortByCreateDate() {
        customers.sort(new ComparatorByCreateDate());
        showCustomers();
    }
